...
Legend_fig <- cowplot::ggdraw() + cowplot::draw_image("~/data/Legend_Fig10A.png", scale = 1)
#Legend_fig <- readPNG(system.file("img", str_c(maindir, "", "/data/Legend_Fig10A.png", package="png")
