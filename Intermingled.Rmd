...
setwd("~/Desktop/last_version_segregation/Analysis/data")
...
setwd("~/Desktop/last_version_segregation/Analysis/data/lg_high_chat")
titer <- "high"
method <- "G_Rab_ChAT_RGT"
data_all <- Data_building(data_all, titer, method) 

## -- TA high G_Rab_ChAT_RGT -- ##
setwd("~/Desktop/last_version_segregation/Analysis/data/ta_high_chat")
titer <- "high"
method <- "G_Rab_ChAT_RGT"
data_all <- Data_building(data_all, titer, method) 

## -- LG low G_Rab_ChAT_RGT -- ##
setwd("~/Desktop/last_version_segregation/Analysis/data/lg_low_chat")
titer <- "low"
method <- "G_Rab_ChAT_RGT"
data_all <- Data_building(data_all, titer, method) 

## -- TA low G_Rab_ChAT_RGT -- ##
setwd("~/Desktop/last_version_segregation/Analysis/data/ta_low_chat")
titer <- "low"
method <- "G_Rab_ChAT_RGT"
data_all <- Data_building(data_all, titer, method) 

## -- MG G_Rab_ChAT_RGT -- ##
setwd("~/Desktop/last_version_segregation/Analysis/data/mg_chat")
titer <- "high"
method <- "G_Rab_ChAT_RGT"
data_all <- Data_building(data_all, titer, method) 

## -- PL G_Rab_ChAT_RGT -- ##
setwd("~/Desktop/last_version_segregation/Analysis/data/pl_chat")
titer <- "high"
method <- "G_Rab_ChAT_RGT"
data_all <- Data_building(data_all, titer, method) 

## -- GS G_Rab_Olig2_RGT -- ##
setwd("~/Desktop/last_version_segregation/Analysis/data/gs_olig2")
titer <- "high"
method <- "G_Rab_Olig2_RGT"
data_all <- Data_building(data_all, titer, method)

## -- TA G_Rab_Olig2_RGT -- ##
setwd("~/Desktop/last_version_segregation/Analysis/data/ta_olig2")
titer <- "high"
method <- "G_Rab_Olig2_RGT"
data_all <- Data_building(data_all, titer, method)

## -- GS AAV-G_WT -- ##
setwd("~/Desktop/last_version_segregation/Analysis/data/gs_aav_wt")
titer <- "high"
method <- "AAV-G_WT"
data_all <- Data_building(data_all, titer, method)

## -- TA AAV-G_WT -- ##
setwd("~/Desktop/last_version_segregation/Analysis/data/ta_aav_wt")
titer <- "high"
method <- "AAV-G_WT"
data_all <- Data_building(data_all, titer, method)
...
## -- GS AAV-G_ChAT -- ##
setwd("~/Desktop/last_version_segregation/Analysis/data/gs_aav_chat")
titer <- "high"
method <- "AAV-G-FLEX_ChAT-cre"
data_all <- Data_building(data_all, titer, method)

## -- TA AAV-G_ChAT -- ##
setwd("~/Desktop/last_version_segregation/Analysis/data/ta_aav_chat")
titer <- "high"
method <- "AAV-G-FLEX_ChAT-cre"
data_all <- Data_building(data_all, titer, method)

## -- GS PRV -- ##
setwd("~/Desktop/last_version_segregation/Analysis/data/gs_prv")
titer <- "high"
method <- "PRV_WT"
data_all <- Data_building(data_all, titer, method)

## -- TA PRV -- ##
setwd("~/Desktop/last_version_segregation/Analysis/data/ta_prv")
titer <- "high"
method <- "PRV_WT"
data_all <- Data_building(data_all, titer, method)
...
setwd("~/Desktop/last_version_segregation/Analysis/data_raw")
titer <- "high"
method <- "G_Rab_ChAT_RGT"
panel <- c("A", "B", "C", "D", "E", "F")
segment <- c("L1", "L2", "L3", "L4", "L5", "L6")
...
## -- G -- ##
Figure_4supp1G <- boxplot_per_sample_titer(data_all, method_used, titer_used, ta, color_ta, color_pl, ymin_d, ymax_950)
...
Figure_4supp1H <- Boxplot_individual(dat4supp1D, color_ta, color_pl, ymin_d, ymax_950)
...
```{r,  warning=FALSE, fig.align='left', fig.width= 5 , fig.height= 5}
...
setwd("~/Desktop/last_version_segregation/Analysis/data/lg_exc_chat")
titer <- "NA"
method <- "G_Rab_ChAT_RGT"
data_fig6 <- Data_building(data_fig6, titer, method_used) 
setwd("~/Desktop/last_version_segregation/Analysis/data/ta_exc_chat")
data_fig6 <- Data_building(data_fig6, titer, method_used)
setwd("~/Desktop/last_version_segregation/Analysis/data/lg_inh_chat")
data_fig6 <- Data_building(data_fig6, titer, method_used)
setwd("~/Desktop/last_version_segregation/Analysis/data/ta_inh_chat")
data_fig6 <- Data_building(data_fig6, titer, method_used)
```
...
Figure_6F_dorsal_interactive <- Boxplot_individual_interactive(dat_6F_dorsal, color_lg, color_ta, ymin_vd, ymax_850)
...
Figure_6F_ventral_interactive <- Boxplot_individual_interactive(dat_6F_ventral, color_lg, color_ta, ymin_vd, ymax_850)
...
R <- 100 # Set here the number of replicates that you want
N <- c(21, 21)
lim <- c(-850, 850, -450, 450)
titer_used <- 0
...
method_used <- "G_Rab_Olig2_RGT"
Animal <- "1332_n_nz"
plot_xy_1332_n_nz_interactive <- xy_dot_interactive(spinal, data_all,Animal, color_gs, transpa)
